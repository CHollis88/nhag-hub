...
export const PATCH_NOTES = [
  {
    ...
    items: [
      ...
      "Tapping a song's link (Sheet Music, Lyrics, Chords, any voice part, Split Track, Demo) now opens it full-screen right in the app instead of leaving to Drive — works the same in Songs and inside a Program's songs.",
