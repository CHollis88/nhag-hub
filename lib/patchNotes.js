...
export const PATCH_NOTES = [
  {
    ...
    items: [
      ...
      "Fixed a serious crash (sometimes the whole page, not just the viewer) that could happen closing Lyrics while a track was also playing — the PDF viewer no longer gets torn down just from being hidden, only when you actually switch to a different document.",
